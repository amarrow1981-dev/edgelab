...
def build_dataframe(
    ...
    for tier, league_id in LEAGUE_MAP.items():
        ...
        for fx in fixtures:
            ...
            # Silent side effect — write to harvester DB so the unified
            # dataset captures every fixture DataBot touches.
            ...
            try:
                ...
                pass  # harvester write is best-effort — never blocks DataBot
